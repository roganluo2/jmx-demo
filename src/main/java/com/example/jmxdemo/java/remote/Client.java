...
package com.example.jmxdemo.java.remote;

import com.example.jmxdemo.java.mxbean.QueueSample;
import com.example.jmxdemo.java.mxbean.QueueSamplerMXBean;
import com.example.jmxdemo.java.notifications.HelloMBean;
...
//        manageStandBean(listener, mbsc);

        // ------------------------------
        // Manage the QueueSampler MXBean
        // ------------------------------
        managementMxbean(mbsc);
    ...
    private static void manageStandBean(ClientListener listener, MBeanServerConnection mbsc)
        ...
        //
        ObjectName mbeanName = new ObjectName("com.example.jmxdemo.java.notifications:type=Hello");
    ...
    private static void managementMxbean(MBeanServerConnection mbsc) throws MalformedObjectNameException {
        // ------------------------------
        // Manage the QueueSampler MXBean
        // ------------------------------
        ...
        ObjectName mxbeanName =
            new ObjectName("com.example.jmxdemo.java.mxbean:type=QueueSampler");
